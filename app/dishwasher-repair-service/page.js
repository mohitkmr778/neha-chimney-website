...
export default function DishwasherRepairServicePage() {
    return (
        <>
            <PageBanner
                title="Dishwasher Repair Service"
                subtitle="Get reliable Kitchen-Chimney repair services in Noida with 24x7 support. Expert technicians for all brands, fast and affordable repairs. Now."
            ...
            <main className="bg-[#f6fbfd] py-10">
                <div className="max-w-[1200px] mx-auto px-4">
                    ...
                    <p className="text-[#222] mb-2 text-base">
                        Get reliable Kitchen-Chimney repair services in Noida
